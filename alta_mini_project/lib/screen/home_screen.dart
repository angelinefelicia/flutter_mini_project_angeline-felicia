...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Stream<QuerySnapshot<Map<String, dynamic>>> streamDatabase() {
    if (spCategory == "All") {
      return db.collection(dbCollection).snapshots();
    }
    return db
                                      ...
                                      showDialog(
                                          ...
                                          builder: (context) {
                                            return EditItemScreen(
                                              ...
                                              titleData:
                                                  data[index].data()['title'],
                                              expdateData: data[index]
                                                  .data()['date_exp'],
                                              categoryData: data[index]
                                                  .data()['category'],
                                              reminddateData: data[index]
                                                  .data()['date_remind'],
                                              remindtimeData: data[index]
                                                  .data()['time_remind'],
